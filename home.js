...
const nbabuttonElement = document.querySelectorAll('.nbabutton');
nbabuttonElement.forEach((el) => observer.observe(el));
...
const img3Element = document.querySelectorAll('.img3');
img3Element.forEach((el) => observer.observe(el));
